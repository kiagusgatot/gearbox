...
class BookingController extends Controller
{
    ...
    {
        return response()->json(['data' => Booking::with(['user', 'customer', 'vehicle', 'service', 'mechanic'])->get()]);
    }
            ...
            return response()->json([
                'data' => [
                    ...
                    'summary' => [
                        ...
                        'total_cost' => $serviceBasePrice,
                        'total_duration' => $service ? (int)$service->estimated_duration : 0
                    ]
                ]
            ]);
        }
