    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:16px; overflow:hidden;">
        ...
        <tr><td style="padding:40px 32px;">
          <h2 style="color:#111111; font-size:20px; margin:0 0 8px;">Reset Password</h2>
          <p style="color:#6B6B6B; font-size:14px; line-height:1.6; margin:0 0 8px;">
            Halo, {{ $user->name }}.
          </p>
          <p style="color:#6B6B6B; font-size:14px; line-height:1.6; margin:0 0 24px;">
            Kami menerima permintaan untuk reset password akun GEARBOX Anda. Klik tombol di bawah untuk membuat password baru.
          </p>
          
          <!-- CTA Button -->
          <table width="100%" cellpadding="0" cellspacing="0">
            <tr><td align="center">
              <a href="{{ $resetUrl }}" style="display:inline-block; background:#FFD400; color:#111111; font-size:16px; font-weight:bold; text-decoration:none; padding:14px 40px; border-radius:12px;">
                Reset Password Saya
              </a>
            </td></tr>
          </table>
          ...
          <p style="color:#9CA3AF; font-size:11px; margin:0;">
            ...
            <a href="{{ $resetUrl }}" style="color:#FFD400; word-break:break-all;">{{ $resetUrl }}</a>
          </p>
        </td></tr>
