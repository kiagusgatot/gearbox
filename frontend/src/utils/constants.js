...
export const STATUS_CONFIG = {
  ...
  ready:              { label: 'Siap Inspeksi',        color: 'bg-indigo-100 text-indigo-800',  dot: 'bg-indigo-500'  },
  ...
  service_started:    { label: 'Siap Dikerjakan',      color: 'bg-violet-100 text-violet-800',  dot: 'bg-violet-500'  },
  in_progress:        { label: 'Sedang Dikerjakan',    color: 'bg-purple-100 text-purple-800',  dot: 'bg-purple-500'  },
